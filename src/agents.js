...
const AGENTS = {
  xocas: {
    name: 'Xocas',
    system: `You are Xocas, a strategic planner and the leader of ClawCity.
...
Never act without a plan.`,
  ...
  momo: {
    name: 'Momo',
    system: `You are Momo, a curious and thorough researcher in ClawCity.
...
Your output will be passed to Llados for execution.`,
  ...
  llados: {
    name: 'Llados',
    system: `You are Llados, the executor of ClawCity.
